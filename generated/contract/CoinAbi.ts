...
export class e_addCoinbyGatorForPay extends ethereum.Event {
  get params(): e_addCoinbyGatorForPay__Params {
    return new e_addCoinbyGatorForPay__Params(this);
  }
}

export class e_addCoinbyGatorForPay__Params {
  _event: e_addCoinbyGatorForPay;

  constructor(event: e_addCoinbyGatorForPay) {
    this._event = event;
  }
